...
if uploaded_file:
    ...
    # --- Pointer to PO Generator app ---
    st.info(
        "📝 **Need to create a Purchase Order?** PO generation has moved to the dedicated "
        "[**PO Generator app**](https://web-production-ce7a4.up.railway.app). "
        "It will pull this cutlist directly from the Odoo project task — or you can upload "
        "the Excel file you downloaded above."
    )
